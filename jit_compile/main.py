...
with open('temp/one_fish_CL.pkl', 'wb') as f:
    pickle.dump(fish_tank.output, f)
with open('temp/one_fish_CL_Gamma.pkl', 'wb') as f:
    pickle.dump(fish_tank.output_Gamma, f)
with open('temp/one_fish_CL_bvs.pkl', 'wb') as f:
    pickle.dump(fish_tank.output_bvs, f)
with open('temp/one_fish_CL_bvs_gamma.pkl', 'wb') as f:
    pickle.dump(fish_tank.output_bvs_gamma, f)

# Store control inputs
with open('temp/one_fish_CL_control_input.pkl', 'wb') as f:
    pickle.dump(Nemo.control_inputs, f)

# Load simulation outputs
with open('temp/one_fish_CL.pkl', 'rb') as f:
    sim_output = pickle.load(f)
with open('temp/one_fish_CL_Gamma.pkl', 'rb') as f:
    sim_output_Gamma = pickle.load(f)
with open('temp/one_fish_CL_bvs.pkl', 'rb') as f:
    sim_output_bvs = pickle.load(f)
with open('temp/one_fish_CL_bvs_gamma.pkl', 'rb') as f:
